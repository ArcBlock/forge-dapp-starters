![forge-lottery-dapp](https://www.arcblock.io/.netlify/functions/badge/?text=forge-lottery-dapp)
...
[Live preview](https://forge-lottery-dapp.netlify.com/)
...
```terminal
npm install -g @arcblock/forge-cli forge-lottery-dapp
forge install
forge start
...
cd forge-dapp-starters/packages/forge-lottery-dapp
yarn
yarn start
```
